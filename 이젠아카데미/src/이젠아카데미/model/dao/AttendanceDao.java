...
public class AttendanceDao extends Dao{
	...
	public boolean attendAction(int loginSession) {
		if( isPresentToday(  loginSession ) ) return false;
	...
	public boolean isPresentToday( int loginSession ) {
		try {
	...
	public int checkInCount(int loginSession) {
		try {
	...
	public int totalDaysAttended(int loginSession) {
		try {
